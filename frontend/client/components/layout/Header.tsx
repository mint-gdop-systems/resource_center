...
export default function Header({ onToggleMobileSidebar }: HeaderProps) {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-4 py-3 sm:px-6 lg:px-8 transition-colors duration-300">
        ...
        <div className="flex-1 max-w-lg mx-4" ref={searchRef}>
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-10 py-2 border border-gray-300 dark:border-gray-600 rounded-lg leading-5 bg-white dark:bg-gray-800 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-mint-500 focus:border-transparent text-sm transition-all duration-200"
            />
            {searchQuery && (
              <button
                ...
                {isSearching ? (
                  ...
                  <div className="py-2">
                    ...
                    {searchResults.map((item, index) => (
                      ...
                      >
                        <div className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${item.type === 'folder'
          ...
          {initialized && authenticated && user ? (
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-2 p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-mint-500"
              >
                <UserCircleIcon className="h-8 w-8 text-gray-400" />
                <div className="hidden md:block text-left">
                  <p className="text-sm font-medium text-gray-900 dark:text-white hover:text-gray-900 dark:hover:text-white">
                    {displayName}
                  </p>
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-700 py-2">
                    ...
                    >
                      <ArrowRightOnRectangleIcon className="h-5 w-5 mr-3 text-gray-400 dark:text-gray-500" />
                      Sign out
                    </button>
                  </div>
                </div>
