...
from . import views
from .views import FileUploadView, CreateFolderView, FolderContentsView, ToggleStarredView, ToggleArchivedView, ToggleFolderStarredView, MetaSearchView
...
urlpatterns = [
    ...
    path("api/meta-search/", MetaSearchView.as_view(), name="meta-search"),
]
